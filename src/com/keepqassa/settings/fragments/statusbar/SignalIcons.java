...
public class SignalIcons extends SettingsPreferenceFragment
    ...
    private static final String SIGNAL_ICONS = "signal_icons";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.keepqassa_settings_signalicons);
    ...
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
                    ...
                    sir.xmlResId = R.xml.keepqassa_settings_signalicons;
                    result.add(sir);
