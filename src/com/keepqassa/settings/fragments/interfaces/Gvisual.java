...
public class Gvisual extends SettingsPreferenceFragment implements
    ...
    private void setupNavbarSwitchPref() {
        ...
        if (qassaUtils.isNavbarColor("com.gnonymous.gvisualmod.pgm_rose")){
            mnbSwitch.setValue("6");
        } else if (qassaUtils.isNavbarColor("com.gnonymous.gvisualmod.pgm_blue")){
            mnbSwitch.setValue("5");
        } else if (qassaUtils.isNavbarColor("com.gnonymous.gvisualmod.pgm_purp")){
            mnbSwitch.setValue("4");
        } else if (qassaUtils.isNavbarColor("com.gnonymous.gvisualmod.pgm_oprd")){
            mnbSwitch.setValue("3");
        } else if (qassaUtils.isNavbarColor("com.gnonymous.gvisualmod.pgm_orcd")){
    ...
    private void setupHeaderSwitchPref() {
        ...
        if (qassaUtils.isThemeEnabled("com.android.theme.header.xlarge")){
            mhdSize.setValue("3");
        } else if (qassaUtils.isThemeEnabled("com.android.theme.header.large")){
            mhdSize.setValue("2");
        }
        else{
            mhdSize.setValue("1");
