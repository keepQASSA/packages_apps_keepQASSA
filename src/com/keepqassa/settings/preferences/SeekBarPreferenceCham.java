package com.keepqassa.settings.preferences;
...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String KEEPQASSANS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, KEEPQASSANS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, KEEPQASSANS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(KEEPQASSANS, "interval");
            if(newInterval != null)
